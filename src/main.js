...
function createFloor() {
    ...
    const rbInfo = new Ammo.btRigidBodyConstructionInfo(0, motion, shape, localInertia);
...
function createCubes() {
    for (let i = 0; i < 10; i++) {
        ...
        createRigidBody(mesh, new Ammo.btBoxShape(new Ammo.btVector3(0.5, 0.5, 0.5)), 1);
...
function createRigidBody(mesh, shape, mass) {
    ...
    const rbInfo = new Ammo.btRigidBodyConstructionInfo(mass, motion, shape, localInertia);
    const body = new Ammo.btRigidBody(rbInfo);
